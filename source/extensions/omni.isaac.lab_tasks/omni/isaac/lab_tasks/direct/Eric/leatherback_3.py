...
# Train to drive forward or backward
...
class LeatherbackEnvCfg(DirectRLEnvCfg):
    ...
    observation_space = 2       # Number of observations fed into neural network
...
class LeatherbackEnv(DirectRLEnv):
    ...
    def _reset_idx(self, env_ids: Sequence[int] | None):
        ...
        self.previous_throttle[env_ids] = 0.0
